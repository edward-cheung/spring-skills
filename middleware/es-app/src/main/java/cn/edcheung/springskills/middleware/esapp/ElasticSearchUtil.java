...
public class ElasticSearchUtil {
    ...
    private void init() {
        try {
            ...
            if (StringUtils.isBlank(uris)) {
                logger.error("spring.elasticsearch.rest.uris is blank");
                return;
            }
    ...
    public String updateDataById(Object object, String index, String id) throws IOException {
        ...
        logger.info("索引为: {}, id为: {},updateResponseID：{}, 更新数据成功", index, id, updateResponse.getId());
    ...
    public String updateDataByIdNoRealTime(Object object, String index, String id) throws IOException {
        ...
        //执行更新请求
        UpdateResponse updateResponse = restHighLevelClient.update(updateRequest, RequestOptions.DEFAULT);
        logger.info("索引为: {}, id为: {},updateResponseID：{}, 实时更新数据成功", index, id, updateResponse.getId());
        return updateResponse.getId();
    }
