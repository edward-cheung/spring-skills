package cn.edcheung.springskills.codegenerator02;
...
public class BasePlugin extends PluginAdapter {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        set.add(new FullyQualifiedJavaType(cn.edcheung.springskills.codegenerator02.Annotation.ApiModel.getClazz()));
        set.add(new FullyQualifiedJavaType(cn.edcheung.springskills.codegenerator02.Annotation.DATA.getClazz()));
        topLevelClass.addImportedTypes(set);

        topLevelClass.addAnnotation(cn.edcheung.springskills.codegenerator02.Annotation.ApiModel.getAnnotation() + "(value=\"" + topLevelClass.getType() + "\",description=\"" + introspectedTable.getRemarks() + "\")");
        topLevelClass.addAnnotation(cn.edcheung.springskills.codegenerator02.Annotation.DATA.getAnnotation() + "()");
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        Set<FullyQualifiedJavaType> set = new HashSet<FullyQualifiedJavaType>();
        set.add(new FullyQualifiedJavaType(cn.edcheung.springskills.codegenerator02.Annotation.Mapper.getClazz()));
        interfaze.addImportedTypes(set);
        interfaze.addAnnotation(cn.edcheung.springskills.codegenerator02.Annotation.Mapper.getAnnotation() + "()");
    ...
    public boolean modelFieldGenerated(Field field, TopLevelClass topLevelClass, IntrospectedColumn introspectedColumn, IntrospectedTable introspectedTable, ModelClassType modelClassType) {
        ...
        topLevelClass.addImportedType(new FullyQualifiedJavaType(cn.edcheung.springskills.codegenerator02.Annotation.ApiModelProperty.getClazz()));
        field.addAnnotation(cn.edcheung.springskills.codegenerator02.Annotation.ApiModelProperty.getAnnotation() + "(value=\"" + introspectedColumn.getRemarks() + "\",name=\"" + introspectedColumn.getJavaProperty() + "\")");

        // 追加长度验证注解
        String a = field.getType().getShortName();
        if (StringUtils.equals("String", a)) {
            topLevelClass.addImportedType(new FullyQualifiedJavaType(cn.edcheung.springskills.codegenerator02.Annotation.Length.getClazz()));
            field.addAnnotation(cn.edcheung.springskills.codegenerator02.Annotation.Length.getAnnotation() + "(max = " + introspectedColumn.getLength() + ", message = \"" + introspectedColumn.getRemarks() + "名长度最长为" + introspectedColumn.getLength() + "\")");
        }
        // 追加日期格式化注解
        if ("TIMESTAMP".equals(introspectedColumn.getJdbcTypeName())) {
            field.addAnnotation(cn.edcheung.springskills.codegenerator02.Annotation.JsonFormat.getAnnotation() + "(pattern = \"yyyy-MM-dd\",timezone=\"GMT+8\")");
            topLevelClass.addImportedType(new FullyQualifiedJavaType(cn.edcheung.springskills.codegenerator02.Annotation.JsonFormat.getClazz()));
        }
    ...
    public void generateControllerFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) throws IOException, TemplateException {
        ...
        if (packageController != null) {
            ...
            Template template = cn.edcheung.springskills.codegenerator02.FreeMarkerTemplateUtils.getTemplate("Controller.ftl");
    ...
    public void generateVoFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) throws IOException, TemplateException {
        ...
        if (packageVo != null) {
            ...
            Template template = cn.edcheung.springskills.codegenerator02.FreeMarkerTemplateUtils.getTemplate("Vo.ftl");
            FileOutputStream fos = new FileOutputStream(mapperFile);
            Writer out = new BufferedWriter(new OutputStreamWriter(fos, StandardCharsets.UTF_8), 10240);
    ...
    public void generateServiceFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) throws IOException, TemplateException {
        ...
        if (packageService != null) {
            ...
            Template template = cn.edcheung.springskills.codegenerator02.FreeMarkerTemplateUtils.getTemplate("Service.ftl");
            FileOutputStream fos = new FileOutputStream(mapperFile);
            Writer out = new BufferedWriter(new OutputStreamWriter(fos, StandardCharsets.UTF_8), 10240);
    ...
    public void generateImplFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) throws IOException, TemplateException {
        ...
        if (packageImpl != null) {
            ...
            Template template = cn.edcheung.springskills.codegenerator02.FreeMarkerTemplateUtils.getTemplate("Impl.ftl");
            FileOutputStream fos = new FileOutputStream(mapperFile);
            Writer out = new BufferedWriter(new OutputStreamWriter(fos, StandardCharsets.UTF_8), 10240);
